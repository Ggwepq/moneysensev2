...
/// MoneySense brand and semantic colors.
///
/// Accent colors are identical in both light and dark themes per design spec.
/// High-contrast palette chosen for maximum legibility for users with low vision.
///
/// WCAG AA contrast ratios:
///   accentYellow (#E2DA00) on darkBackground (#010F1C) → ~13.6:1  ✓ large text
///   accentBlue   (#1E30F0) on lightBackground(#F5F5F5) → ~5.0:1   ✓ AA normal
///   darkOnSurface(#FFFFFF) on darkSurface   (#1A1A1A)  → ~15.7:1  ✓
///   lightOnSurface(#0E0E0E) on lightSurface (#FFFFFF)  → ~19.6:1  ✓
