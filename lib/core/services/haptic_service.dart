...
// Three intensity levels: subtle (HapticFeedback only), medium (single motor pulse),
// and strong (unique multi-pulse per event). Device capabilities are cached at startup
// so vibration patterns fire immediately without async delay.
