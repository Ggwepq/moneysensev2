...
class _DenominationVibrationTutorialState
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 600), () {
      ...
      ref.read(ttsServiceProvider).enqueue(
        TutorialSpeech.hapticGuide(l10n),
        enabled: s.ttsEnabled,
        currentVerbosity: s.ttsVerbosity,
      );
    });
  } // index of the currently playing row
  ...
  Future<void> _play(int index) async {
    ...
    try {
      final hasV = (await Vibration.hasVibrator()) == true;
      if (hasV) {
  ...
  Widget build(BuildContext context) {
    ...
    return MsTutorialScaffold(
      ...
      heroSemantic: l10n.hapticHeroSemantic,
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: yellow.withValues(alpha: 0.5), width: 1.5),
              ),
              child: Row(
                children: [
                  Container(
